...
function getAirlines($page) {
    ...
    CURLOPT_URL => 'https://www.airlines-inform.com/north_america/?ajx=Y&PAGEN_1=' . $page,
    ...
    CURLOPT_HTTPHEADER => array(
        ...
        'referer: https://www.airlines-inform.com/north_america/2.html',
...
$fileName = "north_america.csv";
$targetUrl = "/north_america";
$pageCount = 4;
